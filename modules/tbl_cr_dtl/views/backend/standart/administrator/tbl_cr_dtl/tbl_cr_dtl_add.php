...
<section class="content-header">
    <h1>
        CR Input Detail        <small><?= cclang('new', ['CR Input Detail']); ?> </small>
    </h1>
    <ol class="breadcrumb">
                ...
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <div class="widget-user-header ">
                            ...
                            <h5 class="widget-user-desc"><?= cclang('new', ['CR Input Detail']); ?></h5>
                            <hr>
                        </div>
                        <?= form_open('', [
                        ...
                        ?>
                            ...
                            <div class="col-sm-8">
                                <input type="number" class="form-control" name="cr_id_hdr" id="cr_id_hdr" placeholder="Cr Id Hdr" value="<?= set_value('cr_id_hdr'); ?>">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="cr_uraian" id="cr_uraian" placeholder="Cr Uraian" value="<?= set_value('cr_uraian'); ?>">
                                <small class="info help-block">
...
<script>
    $(document).ready(function(){
      ...
      $('.btn_save').click(function(){
        ...
        $.ajax({
          url: BASE_URL + '/administrator/tbl_cr_dtl/add_save',
          type: 'POST',
          dataType: 'json',
          data: data_post,
        })
