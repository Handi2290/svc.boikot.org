...
class Model_api_form_form_kode_cost_cr extends MY_Model {

private $primary_key = 'id';
private $table_name = 'form_form_kode_cost_cr';
private $field_search = ['id', 'kode_cost_product', 'kode_cost_induk', 'kode_cost_cabang', 'kode_cost_ranting', 'kode_cost_uraian'];
