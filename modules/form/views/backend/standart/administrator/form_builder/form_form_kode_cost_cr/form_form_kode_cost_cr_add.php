...
<section class="content-header">
    <h1>
        Form Kode Cost CR        <small>New Form Kode Cost CR</small>
    </h1>
    <ol class="breadcrumb">
                ...
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <div class="widget-user-header ">
                            ...
                            <h5 class="widget-user-desc">New Form Kode Cost CR</h5>
                            <hr>
                        </div>
                        <?= form_open('', [
    ...
    $(document).ready(function(){
      ...
      $('#btn_cancel').click(function(){
        swal({
          ...
          function(isConfirm){
            if (isConfirm) {
              window.location.href = BASE_URL + 'administrator/manage-form/form_form_kode_cost_cr';
            }
          });
      ...
      $('.btn_save').click(function(){
        ...
        $.ajax({
          url: BASE_URL + '/administrator/manage-form/form_form_kode_cost_cr/add_save',
          type: 'POST',
          dataType: 'json',
          data: data_post,
        })
