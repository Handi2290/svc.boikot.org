...
<section class="content-header">
    <h1>
        CR Input Header        <small>New CR Input Header</small>
    </h1>
    <ol class="breadcrumb">
                ...
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <div class="widget-user-header ">
                            ...
                            <h5 class="widget-user-desc">New CR Input Header</h5>
                            <hr>
                        </div>
                        <?= form_open('', [
...
<script>
    $(document).ready(function(){
      ...
      $('.btn_save').click(function(){
        ...
        $.ajax({
          url: BASE_URL + '/administrator/manage-form/form_cr_input_header/add_save',
          type: 'POST',
          dataType: 'json',
          data: data_post,
        })
